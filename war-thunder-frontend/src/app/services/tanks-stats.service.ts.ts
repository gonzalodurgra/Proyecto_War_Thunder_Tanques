...
export class TanksStatsService {
  ...
  obtenerColoresTanque(tanque: Tanque, usarRatingEspecifico: boolean = true): { [key: string]: string } {
    ...
    return {
      ...
      velocidad_adelante_arcade_arcade: this.obtenerColor('velocidad_adelante_arcade', tanque.velocidad_adelante_arcade, rating_arcade),
      velocidad_atras_arcade_arcade: this.obtenerColor('velocidad_atras_arcade', tanque.velocidad_atras_arcade, rating_arcade),
      potencia_peso_arcade_arcade: this.obtenerColor('relacion_potencia_peso', tanque.relacion_potencia_peso, rating_arcade),
      ...
      tripulacion_realista: this.obtenerColor('tripulacion', tanque.tripulacion, rating_arcade),
