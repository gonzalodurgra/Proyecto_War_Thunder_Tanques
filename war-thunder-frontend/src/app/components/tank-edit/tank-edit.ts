...
export class TankEditComponent implements OnInit {
  ...
  crearTanqueVacio(): Tanque {
    return {
      ...
      velocidad_adelante_realista: 0,
      velocidad_atras_arcade: 0,
      velocidad_atras_realista: 0,
      relacion_potencia_peso: 0,
      relacion_potencia_peso_realista: 0,
      angulo_depresion: 0,
      angulo_elevacion: 0,
      recarga: 0,
      cadencia: 0,
      ...
      rotacion_torreta_horizontal_realista: 0,
      rotacion_torreta_vertical_arcade: 0,
      rotacion_torreta_vertical_realista: 0,
      armamento: {
